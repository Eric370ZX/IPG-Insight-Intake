...
namespace Insight.Intake
{
	...
	public partial class Subject : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.AsyncOperation> Subject_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.AsyncOperation>("Subject_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("Subject_AsyncOperations");
				this.SetRelatedEntities<Insight.Intake.AsyncOperation>("Subject_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.Incident> subject_incidents
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.Incident>("subject_incidents", null);
			}
			set
			{
				this.OnPropertyChanging("subject_incidents");
				this.SetRelatedEntities<Insight.Intake.Incident>("subject_incidents", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.KbArticle> subject_kb_articles
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.KbArticle>("subject_kb_articles", null);
			}
			set
			{
				this.OnPropertyChanging("subject_kb_articles");
				this.SetRelatedEntities<Insight.Intake.KbArticle>("subject_kb_articles", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.KnowledgeArticle> subject_knowledgearticles
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.KnowledgeArticle>("subject_knowledgearticles", null);
			}
			set
			{
				this.OnPropertyChanging("subject_knowledgearticles");
				this.SetRelatedEntities<Insight.Intake.KnowledgeArticle>("subject_knowledgearticles", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.Subject> Referencedsubject_parent_subject
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.Subject>("subject_parent_subject", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedsubject_parent_subject");
				this.SetRelatedEntities<Insight.Intake.Subject>("subject_parent_subject", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.Product> subject_products
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.Product>("subject_products", null);
			}
			set
			{
				this.OnPropertyChanging("subject_products");
				this.SetRelatedEntities<Insight.Intake.Product>("subject_products", null, value);
		...
		public Insight.Intake.ExternalParty lk_externalparty_subject_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.ExternalParty>("lk_externalparty_subject_createdby", null);
			}
		}
		...
		public Insight.Intake.ExternalParty lk_externalparty_subject_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.ExternalParty>("lk_externalparty_subject_modifiedby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_subject_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_subject_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_subject_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_subject_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_subject_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_subject_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_subject_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_subject_modifiedonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_subjectbase_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_subjectbase_createdby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_subjectbase_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_subjectbase_modifiedby", null);
			}
		}
		...
		public Insight.Intake.Subject Referencingsubject_parent_subject
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.Subject>("subject_parent_subject", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingsubject_parent_subject");
				this.SetRelatedEntity<Insight.Intake.Subject>("subject_parent_subject", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
