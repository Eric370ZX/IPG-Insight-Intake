...
namespace Insight.Intake
{
	...
	public enum ipg_propelcptruleState
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContractAttribute()]
	[Microsoft.Xrm.Sdk.Client.EntityLogicalNameAttribute("ipg_propelcptrule")]
	public partial class ipg_propelcptrule : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public static class Fields
		{
			...
			public const string ipg_isautorizationrequired = "ipg_isautorizationrequired";
			public const string ipg_name = "ipg_name";
			public const string ipg_plantype = "ipg_plantype";
			public const string ipg_propelcptruleId = "ipg_propelcptruleid";
			public const string Id = "ipg_propelcptruleid";
			public const string ipg_propelcptrulelookupId = "ipg_propelcptrulelookupid";
		...
		/// Default Constructor.
		/// </summary>
		public ipg_propelcptrule() : 
				base(EntityLogicalName)
		{
		}
		
		public const string EntityLogicalName = "ipg_propelcptrule";
		
		public const string EntitySchemaName = "ipg_propelcptrule";
		
		public const string PrimaryIdAttribute = "ipg_propelcptruleid";
		
		public const string PrimaryNameAttribute = "ipg_name";
		
		public const string EntityLogicalCollectionName = "ipg_propelcptrules";
		
		public const string EntitySetName = "ipg_propelcptrules";
		...
		/// <summary>
		/// Represents CPT code in this relationship
		/// </summary>
		...
		/// <summary>
		/// Duplicate and misspelled
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ipg_isautorizationrequired")]
		public System.Nullable<bool> ipg_isautorizationrequired
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("ipg_isautorizationrequired");
			}
			set
			{
				this.OnPropertyChanging("ipg_isautorizationrequired");
				this.SetAttributeValue("ipg_isautorizationrequired", value);
				this.OnPropertyChanged("ipg_isautorizationrequired");
			}
		}
		...
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ipg_propelcptruleid")]
		public System.Nullable<System.Guid> ipg_propelcptruleId
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<System.Guid>>("ipg_propelcptruleid");
			}
			set
			{
				this.OnPropertyChanging("ipg_propelcptruleId");
				this.SetAttributeValue("ipg_propelcptruleid", value);
				if (value.HasValue)
				{
					base.Id = value.Value;
				}
				...
				this.OnPropertyChanged("ipg_propelcptruleId");
			}
		}
		...
		public override System.Guid Id
		{
			...
			set
			{
				this.ipg_propelcptruleId = value;
			}
		}
		
		/// <summary>
		/// Incorrect naming convention. Replaced with ipg_cptcodeid
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ipg_propelcptrulelookupid")]
		public Microsoft.Xrm.Sdk.EntityReference ipg_propelcptrulelookupId
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("ipg_propelcptrulelookupid");
			}
			set
			{
				this.OnPropertyChanging("ipg_propelcptrulelookupId");
				this.SetAttributeValue("ipg_propelcptrulelookupid", value);
				this.OnPropertyChanged("ipg_propelcptrulelookupId");
			}
		}
		...
		/// <summary>
		/// Status of the Propel CPT Rule
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("statecode")]
		public System.Nullable<Insight.Intake.ipg_propelcptruleState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Insight.Intake.ipg_propelcptruleState)(System.Enum.ToObject(typeof(Insight.Intake.ipg_propelcptruleState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		/// <summary>
		/// Reason for the status of the Propel CPT Rule
		/// </summary>
		...
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("statuscode")]
		public virtual ipg_propelcptrule_StatusCode? StatusCodeEnum
		{
			get
			{
				return ((ipg_propelcptrule_StatusCode?)(EntityOptionSetEnum.GetEnum(this, "statuscode")));
			}
			set
			{
				this.OnPropertyChanging("StatusCode");
