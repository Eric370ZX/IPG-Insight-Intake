...
namespace Insight.Intake
{
	...
	public partial class Privilege : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.AsyncOperation> Privilege_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.AsyncOperation>("Privilege_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("Privilege_AsyncOperations");
				this.SetRelatedEntities<Insight.Intake.AsyncOperation>("Privilege_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.Role> roleprivileges_association
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.Role>("roleprivileges_association", null);
			}
			set
			{
				this.OnPropertyChanging("roleprivileges_association");
				this.SetRelatedEntities<Insight.Intake.Role>("roleprivileges_association", null, value);
