...
namespace Insight.Intake
{
	...
	public partial class CustomerAddress : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.AsyncOperation> CustomerAddress_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.AsyncOperation>("CustomerAddress_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("CustomerAddress_AsyncOperations");
				this.SetRelatedEntities<Insight.Intake.AsyncOperation>("CustomerAddress_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.PrincipalObjectAttributeAccess> customeraddress_principalobjectattributeaccess
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.PrincipalObjectAttributeAccess>("customeraddress_principalobjectattributeaccess", null);
			}
			set
			{
				this.OnPropertyChanging("customeraddress_principalobjectattributeaccess");
				this.SetRelatedEntities<Insight.Intake.PrincipalObjectAttributeAccess>("customeraddress_principalobjectattributeaccess", null, value);
		...
		public Insight.Intake.Account Account_CustomerAddress
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.Account>("Account_CustomerAddress", null);
			}
			set
			{
				this.OnPropertyChanging("Account_CustomerAddress");
				this.SetRelatedEntity<Insight.Intake.Account>("Account_CustomerAddress", null, value);
		...
		public Insight.Intake.Contact Contact_CustomerAddress
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.Contact>("Contact_CustomerAddress", null);
			}
			set
			{
				this.OnPropertyChanging("Contact_CustomerAddress");
				this.SetRelatedEntity<Insight.Intake.Contact>("Contact_CustomerAddress", null, value);
		...
		public Insight.Intake.SystemUser lk_customeraddress_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_customeraddress_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_customeraddress_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_customeraddress_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_customeraddress_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_customeraddress_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_customeraddress_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_customeraddress_modifiedonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_customeraddressbase_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_customeraddressbase_createdby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_customeraddressbase_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_customeraddressbase_modifiedby", null);
			}
		}
		...
		public Insight.Intake.TransactionCurrency TransactionCurrency_CustomerAddress
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.TransactionCurrency>("TransactionCurrency_CustomerAddress", null);
			}
			set
			{
				this.OnPropertyChanging("TransactionCurrency_CustomerAddress");
				this.SetRelatedEntity<Insight.Intake.TransactionCurrency>("TransactionCurrency_CustomerAddress", null, value);
