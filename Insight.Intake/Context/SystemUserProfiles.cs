...
namespace Insight.Intake
{
	...
	public partial class SystemUserProfiles : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.SystemUser> systemuserprofiles_association
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.SystemUser>("systemuserprofiles_association", null);
			}
			set
			{
				this.OnPropertyChanging("systemuserprofiles_association");
				this.SetRelatedEntities<Insight.Intake.SystemUser>("systemuserprofiles_association", null, value);
