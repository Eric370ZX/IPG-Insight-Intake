...
namespace Insight.Intake
{
	...
	public partial class KnowledgeArticleViews : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		{
			public const string adx_domainname = "adx_domainname";
			public const string adx_referrer = "adx_referrer";
		...
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("adx_domainname")]
		public string adx_domainname
		{
			get
			{
				return this.GetAttributeValue<string>("adx_domainname");
			}
			set
			{
				this.OnPropertyChanging("adx_domainname");
				this.SetAttributeValue("adx_domainname", value);
				this.OnPropertyChanged("adx_domainname");
			}
		}
		...
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("adx_referrer")]
		public Microsoft.Xrm.Sdk.OptionSetValue adx_referrer
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>("adx_referrer");
			}
			set
			{
				this.OnPropertyChanging("adx_referrer");
				this.SetAttributeValue("adx_referrer", value);
				this.OnPropertyChanged("adx_referrer");
			}
		}
		...
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("adx_referrer")]
		public virtual KnowledgeArticleViews_adx_referrer? adx_referrerEnum
		{
			get
			{
				return ((KnowledgeArticleViews_adx_referrer?)(EntityOptionSetEnum.GetEnum(this, "adx_referrer")));
			}
			set
			{
				this.OnPropertyChanging("adx_referrer");
				this.SetAttributeValue("adx_referrer", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
				this.OnPropertyChanged("adx_referrer");
			}
		}
		...
		public System.Nullable<Insight.Intake.KnowledgeArticleViewsState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Insight.Intake.KnowledgeArticleViewsState)(System.Enum.ToObject(typeof(Insight.Intake.KnowledgeArticleViewsState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.PrincipalObjectAttributeAccess> knowledgearticleview_principalobjectattributeaccess
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.PrincipalObjectAttributeAccess>("knowledgearticleview_principalobjectattributeaccess", null);
			}
			set
			{
				this.OnPropertyChanging("knowledgearticleview_principalobjectattributeaccess");
				this.SetRelatedEntities<Insight.Intake.PrincipalObjectAttributeAccess>("knowledgearticleview_principalobjectattributeaccess", null, value);
		...
		public Insight.Intake.KnowledgeArticle knowledgearticle_views
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.KnowledgeArticle>("knowledgearticle_views", null);
			}
			set
			{
				this.OnPropertyChanging("knowledgearticle_views");
				this.SetRelatedEntity<Insight.Intake.KnowledgeArticle>("knowledgearticle_views", null, value);
		...
		public Insight.Intake.SystemUser lk_knowledgearticleviews_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_knowledgearticleviews_createdby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_knowledgearticleviews_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_knowledgearticleviews_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_knowledgearticleviews_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_knowledgearticleviews_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_knowledgearticleviews_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_knowledgearticleviews_modifiedby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_knowledgearticleviews_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_knowledgearticleviews_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_knowledgearticleviews_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_knowledgearticleviews_modifiedonbehalfby", null, value);
		...
		public Insight.Intake.TransactionCurrency transactioncurrency_knowledgearticleviews
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.TransactionCurrency>("transactioncurrency_knowledgearticleviews", null);
			}
		}
