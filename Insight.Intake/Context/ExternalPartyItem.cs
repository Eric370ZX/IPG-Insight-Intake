...
namespace Insight.Intake
{
	...
	public partial class ExternalPartyItem : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Insight.Intake.ExternalPartyItemState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Insight.Intake.ExternalPartyItemState)(System.Enum.ToObject(typeof(Insight.Intake.ExternalPartyItemState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.AsyncOperation> externalpartyitem_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.AsyncOperation>("externalpartyitem_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("externalpartyitem_AsyncOperations");
				this.SetRelatedEntities<Insight.Intake.AsyncOperation>("externalpartyitem_AsyncOperations", null, value);
		...
		public Insight.Intake.Contact Contact_ExternalPartyItems
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.Contact>("Contact_ExternalPartyItems", null);
			}
			set
			{
				this.OnPropertyChanging("Contact_ExternalPartyItems");
				this.SetRelatedEntity<Insight.Intake.Contact>("Contact_ExternalPartyItems", null, value);
		...
		public Insight.Intake.ExternalParty externalparty_entries
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.ExternalParty>("externalparty_entries", null);
			}
			set
			{
				this.OnPropertyChanging("externalparty_entries");
				this.SetRelatedEntity<Insight.Intake.ExternalParty>("externalparty_entries", null, value);
		...
		public Insight.Intake.SystemUser lk_externalpartyitem_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_externalpartyitem_createdby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_externalpartyitem_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_externalpartyitem_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_externalpartyitem_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_externalpartyitem_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_externalpartyitem_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_externalpartyitem_modifiedby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_externalpartyitem_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_externalpartyitem_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_externalpartyitem_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_externalpartyitem_modifiedonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser SystemUser_ExternalPartyItems
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("SystemUser_ExternalPartyItems", null);
			}
			set
			{
				this.OnPropertyChanging("SystemUser_ExternalPartyItems");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("SystemUser_ExternalPartyItems", null, value);
		...
		public Insight.Intake.TransactionCurrency TransactionCurrency_externalpartyitem
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.TransactionCurrency>("TransactionCurrency_externalpartyitem", null);
			}
			set
			{
				this.OnPropertyChanging("TransactionCurrency_externalpartyitem");
				this.SetRelatedEntity<Insight.Intake.TransactionCurrency>("TransactionCurrency_externalpartyitem", null, value);
