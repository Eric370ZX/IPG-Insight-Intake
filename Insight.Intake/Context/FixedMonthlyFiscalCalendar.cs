...
namespace Insight.Intake
{
	...
	public partial class FixedMonthlyFiscalCalendar : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.AsyncOperation> FixedMonthlyFiscalCalendar_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.AsyncOperation>("FixedMonthlyFiscalCalendar_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("FixedMonthlyFiscalCalendar_AsyncOperations");
				this.SetRelatedEntities<Insight.Intake.AsyncOperation>("FixedMonthlyFiscalCalendar_AsyncOperations", null, value);
		...
		public Insight.Intake.SystemUser lk_fixedmonthlyfiscalcalendar_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_fixedmonthlyfiscalcalendar_createdby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_fixedmonthlyfiscalcalendar_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_fixedmonthlyfiscalcalendar_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_fixedmonthlyfiscalcalendar_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_fixedmonthlyfiscalcalendar_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_fixedmonthlyfiscalcalendar_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_fixedmonthlyfiscalcalendar_modifiedby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_fixedmonthlyfiscalcalendar_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_fixedmonthlyfiscalcalendar_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_fixedmonthlyfiscalcalendar_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_fixedmonthlyfiscalcalendar_modifiedonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_fixedmonthlyfiscalcalendar_salespersonid
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_fixedmonthlyfiscalcalendar_salespersonid", null);
			}
			set
			{
				this.OnPropertyChanging("lk_fixedmonthlyfiscalcalendar_salespersonid");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_fixedmonthlyfiscalcalendar_salespersonid", null, value);
		...
		public Insight.Intake.TransactionCurrency transactioncurrency_fixedmonthlyfiscalcalendar
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.TransactionCurrency>("transactioncurrency_fixedmonthlyfiscalcalendar", null);
			}
			set
			{
				this.OnPropertyChanging("transactioncurrency_fixedmonthlyfiscalcalendar");
				this.SetRelatedEntity<Insight.Intake.TransactionCurrency>("transactioncurrency_fixedmonthlyfiscalcalendar", null, value);
