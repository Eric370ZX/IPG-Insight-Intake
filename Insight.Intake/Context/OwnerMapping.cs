...
namespace Insight.Intake
{
	...
	public partial class OwnerMapping : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Insight.Intake.OwnerMappingState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Insight.Intake.OwnerMappingState)(System.Enum.ToObject(typeof(Insight.Intake.OwnerMappingState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public Insight.Intake.SystemUser lk_ownermapping_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_ownermapping_createdby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_ownermapping_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_ownermapping_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_ownermapping_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_ownermapping_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_ownermapping_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_ownermapping_modifiedby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_ownermapping_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_ownermapping_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_ownermapping_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_ownermapping_modifiedonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser OwnerMapping_SystemUser
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("OwnerMapping_SystemUser", null);
			}
			set
			{
				this.OnPropertyChanging("OwnerMapping_SystemUser");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("OwnerMapping_SystemUser", null, value);
