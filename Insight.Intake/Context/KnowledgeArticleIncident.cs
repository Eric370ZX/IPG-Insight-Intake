...
namespace Insight.Intake
{
	...
	public partial class KnowledgeArticleIncident : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Insight.Intake.KnowledgeArticleIncidentState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Insight.Intake.KnowledgeArticleIncidentState)(System.Enum.ToObject(typeof(Insight.Intake.KnowledgeArticleIncidentState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.AsyncOperation> knowledgearticleincident_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.AsyncOperation>("knowledgearticleincident_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("knowledgearticleincident_AsyncOperations");
				this.SetRelatedEntities<Insight.Intake.AsyncOperation>("knowledgearticleincident_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.PrincipalObjectAttributeAccess> knowledgearticleincident_principalobjectattributeaccess
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.PrincipalObjectAttributeAccess>("knowledgearticleincident_principalobjectattributeaccess", null);
			}
			set
			{
				this.OnPropertyChanging("knowledgearticleincident_principalobjectattributeaccess");
				this.SetRelatedEntities<Insight.Intake.PrincipalObjectAttributeAccess>("knowledgearticleincident_principalobjectattributeaccess", null, value);
		...
		public Insight.Intake.KnowledgeArticle incident_knowledgearticles
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.KnowledgeArticle>("incident_knowledgearticles", null);
			}
			set
			{
				this.OnPropertyChanging("incident_knowledgearticles");
				this.SetRelatedEntity<Insight.Intake.KnowledgeArticle>("incident_knowledgearticles", null, value);
		...
		public Insight.Intake.Incident knowledgearticle_incidents
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.Incident>("knowledgearticle_incidents", null);
			}
			set
			{
				this.OnPropertyChanging("knowledgearticle_incidents");
				this.SetRelatedEntity<Insight.Intake.Incident>("knowledgearticle_incidents", null, value);
		...
		public Insight.Intake.SystemUser lk_knowledgearticleincident_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_knowledgearticleincident_createdby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_knowledgearticleincident_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_knowledgearticleincident_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_knowledgearticleincident_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_knowledgearticleincident_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_knowledgearticleincident_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_knowledgearticleincident_modifiedby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_knowledgearticleincident_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_knowledgearticleincident_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_knowledgearticleincident_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_knowledgearticleincident_modifiedonbehalfby", null, value);
		...
		public Insight.Intake.Team team_knowledgearticleincident
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.Team>("team_knowledgearticleincident", null);
			}
		}
		...
		public Insight.Intake.TransactionCurrency transactioncurrency_knowledgearticleincident
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.TransactionCurrency>("transactioncurrency_knowledgearticleincident", null);
			}
		}
		...
		public Insight.Intake.SystemUser user_knowledgearticleincident
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("user_knowledgearticleincident", null);
			}
		}
