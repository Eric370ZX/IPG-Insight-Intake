...
namespace Insight.Intake
{
	...
	public partial class UserSettings : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Insight.Intake.BusinessUnit business_unit_user_settings
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.BusinessUnit>("business_unit_user_settings", null);
			}
			set
			{
				this.OnPropertyChanging("business_unit_user_settings");
				this.SetRelatedEntity<Insight.Intake.BusinessUnit>("business_unit_user_settings", null, value);
		...
		public Insight.Intake.SystemUser lk_usersettings_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_usersettings_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_usersettings_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_usersettings_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_usersettings_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_usersettings_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_usersettings_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_usersettings_modifiedonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_usersettingsbase_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_usersettingsbase_createdby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_usersettingsbase_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_usersettingsbase_modifiedby", null);
			}
		}
		...
		public Insight.Intake.TransactionCurrency transactioncurrency_usersettings
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.TransactionCurrency>("transactioncurrency_usersettings", null);
			}
			set
			{
				this.OnPropertyChanging("transactioncurrency_usersettings");
				this.SetRelatedEntity<Insight.Intake.TransactionCurrency>("transactioncurrency_usersettings", null, value);
		...
		public Insight.Intake.SystemUser user_settings
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("user_settings", null);
			}
			set
			{
				this.OnPropertyChanging("user_settings");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("user_settings", null, value);
