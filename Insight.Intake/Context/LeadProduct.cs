...
namespace Insight.Intake
{
	...
	public partial class LeadProduct : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.AsyncOperation> leadproduct_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.AsyncOperation>("leadproduct_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("leadproduct_AsyncOperations");
				this.SetRelatedEntities<Insight.Intake.AsyncOperation>("leadproduct_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.PrincipalObjectAttributeAccess> leadproduct_PrincipalObjectAttributeAccesses
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.PrincipalObjectAttributeAccess>("leadproduct_PrincipalObjectAttributeAccesses", null);
			}
			set
			{
				this.OnPropertyChanging("leadproduct_PrincipalObjectAttributeAccesses");
				this.SetRelatedEntities<Insight.Intake.PrincipalObjectAttributeAccess>("leadproduct_PrincipalObjectAttributeAccesses", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.Lead> leadproduct_association
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.Lead>("leadproduct_association", null);
			}
			set
			{
				this.OnPropertyChanging("leadproduct_association");
				this.SetRelatedEntities<Insight.Intake.Lead>("leadproduct_association", null, value);
