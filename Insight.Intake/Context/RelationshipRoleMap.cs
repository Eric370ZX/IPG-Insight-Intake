...
namespace Insight.Intake
{
	...
	public partial class RelationshipRoleMap : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.AsyncOperation> RelationshipRoleMap_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.AsyncOperation>("RelationshipRoleMap_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("RelationshipRoleMap_AsyncOperations");
				this.SetRelatedEntities<Insight.Intake.AsyncOperation>("RelationshipRoleMap_AsyncOperations", null, value);
		...
		public Insight.Intake.SystemUser createdby_relationship_role_map
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("createdby_relationship_role_map", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_relationshiprolemap_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_relationshiprolemap_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_relationshiprolemap_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_relationshiprolemap_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_relationshiprolemap_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_relationshiprolemap_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_relationshiprolemap_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_relationshiprolemap_modifiedonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser modifiedby_relationship_role_map
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("modifiedby_relationship_role_map", null);
			}
		}
		...
		public Insight.Intake.RelationshipRole relationship_role_relationship_role_map
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.RelationshipRole>("relationship_role_relationship_role_map", null);
			}
			set
			{
				this.OnPropertyChanging("relationship_role_relationship_role_map");
				this.SetRelatedEntity<Insight.Intake.RelationshipRole>("relationship_role_relationship_role_map", null, value);
