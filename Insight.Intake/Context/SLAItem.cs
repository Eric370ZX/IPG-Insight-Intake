...
namespace Insight.Intake
{
	...
	public partial class SLAItem : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.SLAKPIInstance> msdyn_slaitem_slakpiinstance
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.SLAKPIInstance>("msdyn_slaitem_slakpiinstance", null);
			}
			set
			{
				this.OnPropertyChanging("msdyn_slaitem_slakpiinstance");
				this.SetRelatedEntities<Insight.Intake.SLAKPIInstance>("msdyn_slaitem_slakpiinstance", null, value);
		...
		public Insight.Intake.Calendar calendar_slaitem
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.Calendar>("calendar_slaitem", null);
			}
			set
			{
				this.OnPropertyChanging("calendar_slaitem");
				this.SetRelatedEntity<Insight.Intake.Calendar>("calendar_slaitem", null, value);
		...
		public Insight.Intake.SystemUser lk_slaitembase_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_slaitembase_createdby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_slaitembase_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_slaitembase_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_slaitembase_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_slaitembase_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_slaitembase_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_slaitembase_modifiedby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_slaitembase_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_slaitembase_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_slaitembase_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_slaitembase_modifiedonbehalfby", null, value);
		...
		public Insight.Intake.SLA sla_slaitem_slaId
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SLA>("sla_slaitem_slaId", null);
			}
			set
			{
				this.OnPropertyChanging("sla_slaitem_slaId");
				this.SetRelatedEntity<Insight.Intake.SLA>("sla_slaitem_slaId", null, value);
		...
		public Insight.Intake.TransactionCurrency TransactionCurrency_SLAItem
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.TransactionCurrency>("TransactionCurrency_SLAItem", null);
			}
		}
