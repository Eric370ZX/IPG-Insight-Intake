...
namespace Insight.Intake
{
	...
	public partial class DuplicateRuleCondition : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Insight.Intake.DuplicateRule DuplicateRule_DuplicateRuleConditions
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.DuplicateRule>("DuplicateRule_DuplicateRuleConditions", null);
			}
			set
			{
				this.OnPropertyChanging("DuplicateRule_DuplicateRuleConditions");
				this.SetRelatedEntity<Insight.Intake.DuplicateRule>("DuplicateRule_DuplicateRuleConditions", null, value);
		...
		public Insight.Intake.SystemUser lk_duplicaterulecondition_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_duplicaterulecondition_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_duplicaterulecondition_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_duplicaterulecondition_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_duplicaterulecondition_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_duplicaterulecondition_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_duplicaterulecondition_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_duplicaterulecondition_modifiedonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_duplicateruleconditionbase_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_duplicateruleconditionbase_createdby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_duplicateruleconditionbase_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_duplicateruleconditionbase_modifiedby", null);
			}
		}
