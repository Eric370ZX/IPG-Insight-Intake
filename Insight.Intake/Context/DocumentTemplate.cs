...
namespace Insight.Intake
{
	...
	public partial class DocumentTemplate : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Insight.Intake.SystemUser lk_documenttemplatebase_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_documenttemplatebase_createdby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_documenttemplatebase_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_documenttemplatebase_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_documenttemplatebase_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_documenttemplatebase_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_documenttemplatebase_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_documenttemplatebase_modifiedby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_documenttemplatebase_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_documenttemplatebase_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_documenttemplatebase_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_documenttemplatebase_modifiedonbehalfby", null, value);
