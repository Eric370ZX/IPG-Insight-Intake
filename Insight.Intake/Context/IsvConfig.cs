...
namespace Insight.Intake
{
	...
	public partial class IsvConfig : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.AsyncOperation> IsvConfig_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.AsyncOperation>("IsvConfig_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("IsvConfig_AsyncOperations");
				this.SetRelatedEntities<Insight.Intake.AsyncOperation>("IsvConfig_AsyncOperations", null, value);
		...
		public Insight.Intake.SystemUser lk_isvconfig_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_isvconfig_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_isvconfig_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_isvconfig_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_isvconfig_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_isvconfig_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_isvconfig_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_isvconfig_modifiedonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_isvconfigbase_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_isvconfigbase_createdby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_isvconfigbase_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_isvconfigbase_modifiedby", null);
			}
		}
