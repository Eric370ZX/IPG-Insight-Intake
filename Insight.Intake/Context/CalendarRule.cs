...
namespace Insight.Intake
{
	...
	public partial class CalendarRule : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Insight.Intake.Calendar calendar_calendar_rules
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.Calendar>("calendar_calendar_rules", null);
			}
			set
			{
				this.OnPropertyChanging("calendar_calendar_rules");
				this.SetRelatedEntity<Insight.Intake.Calendar>("calendar_calendar_rules", null, value);
		...
		public Insight.Intake.Calendar inner_calendar_calendar_rules
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.Calendar>("inner_calendar_calendar_rules", null);
			}
			set
			{
				this.OnPropertyChanging("inner_calendar_calendar_rules");
				this.SetRelatedEntity<Insight.Intake.Calendar>("inner_calendar_calendar_rules", null, value);
		...
		public Insight.Intake.SystemUser lk_calendarrule_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_calendarrule_createdby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_calendarrule_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_calendarrule_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_calendarrule_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_calendarrule_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_calendarrule_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_calendarrule_modifiedby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_calendarrule_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_calendarrule_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_calendarrule_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_calendarrule_modifiedonbehalfby", null, value);
		...
		public Insight.Intake.Service service_calendar_rules
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.Service>("service_calendar_rules", null);
			}
			set
			{
				this.OnPropertyChanging("service_calendar_rules");
				this.SetRelatedEntity<Insight.Intake.Service>("service_calendar_rules", null, value);
