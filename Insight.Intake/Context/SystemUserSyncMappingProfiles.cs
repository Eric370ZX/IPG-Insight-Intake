...
namespace Insight.Intake
{
	...
	public partial class SystemUserSyncMappingProfiles : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.SystemUser> systemusersyncmappingprofiles_association
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.SystemUser>("systemusersyncmappingprofiles_association", null);
			}
			set
			{
				this.OnPropertyChanging("systemusersyncmappingprofiles_association");
				this.SetRelatedEntities<Insight.Intake.SystemUser>("systemusersyncmappingprofiles_association", null, value);
