...
namespace Insight.Intake
{
	...
	public partial class Fax : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public static class Fields
		{
			...
			public const string ipg_claimresponseheader_Faxes = "ipg_claimresponseheader_Faxes";
			public const string ipg_cptcode_Faxes = "ipg_cptcode_Faxes";
			public const string ipg_document_Faxes = "ipg_document_Faxes";
			public const string ipg_ehrstaging_Faxes = "ipg_ehrstaging_Faxes";
			public const string ipg_patientpaymentnotification_Faxes = "ipg_patientpaymentnotification_Faxes";
			public const string ipg_procedurename_Faxes = "ipg_procedurename_Faxes";
			public const string ipg_referral_Faxes = "ipg_referral_Faxes";
		...
		public System.Nullable<Insight.Intake.FaxState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Insight.Intake.FaxState)(System.Enum.ToObject(typeof(Insight.Intake.FaxState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.ActivityParty> fax_activity_parties
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.ActivityParty>("fax_activity_parties", null);
			}
			set
			{
				this.OnPropertyChanging("fax_activity_parties");
				this.SetRelatedEntities<Insight.Intake.ActivityParty>("fax_activity_parties", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.Annotation> Fax_Annotation
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.Annotation>("Fax_Annotation", null);
			}
			set
			{
				this.OnPropertyChanging("Fax_Annotation");
				this.SetRelatedEntities<Insight.Intake.Annotation>("Fax_Annotation", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.AsyncOperation> Fax_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.AsyncOperation>("Fax_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("Fax_AsyncOperations");
				this.SetRelatedEntities<Insight.Intake.AsyncOperation>("Fax_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.DuplicateRecord> Fax_DuplicateBaseRecord
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.DuplicateRecord>("Fax_DuplicateBaseRecord", null);
			}
			set
			{
				this.OnPropertyChanging("Fax_DuplicateBaseRecord");
				this.SetRelatedEntities<Insight.Intake.DuplicateRecord>("Fax_DuplicateBaseRecord", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.DuplicateRecord> Fax_DuplicateMatchingRecord
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.DuplicateRecord>("Fax_DuplicateMatchingRecord", null);
			}
			set
			{
				this.OnPropertyChanging("Fax_DuplicateMatchingRecord");
				this.SetRelatedEntities<Insight.Intake.DuplicateRecord>("Fax_DuplicateMatchingRecord", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.PrincipalObjectAttributeAccess> fax_principalobjectattributeaccess
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.PrincipalObjectAttributeAccess>("fax_principalobjectattributeaccess", null);
			}
			set
			{
				this.OnPropertyChanging("fax_principalobjectattributeaccess");
				this.SetRelatedEntities<Insight.Intake.PrincipalObjectAttributeAccess>("fax_principalobjectattributeaccess", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.QueueItem> Fax_QueueItem
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.QueueItem>("Fax_QueueItem", null);
			}
			set
			{
				this.OnPropertyChanging("Fax_QueueItem");
				this.SetRelatedEntities<Insight.Intake.QueueItem>("Fax_QueueItem", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.SLAKPIInstance> slakpiinstance_fax
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.SLAKPIInstance>("slakpiinstance_fax", null);
			}
			set
			{
				this.OnPropertyChanging("slakpiinstance_fax");
				this.SetRelatedEntities<Insight.Intake.SLAKPIInstance>("slakpiinstance_fax", null, value);
		...
		public Insight.Intake.Account Account_Faxes
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.Account>("Account_Faxes", null);
			}
			set
			{
				this.OnPropertyChanging("Account_Faxes");
				this.SetRelatedEntity<Insight.Intake.Account>("Account_Faxes", null, value);
		...
		public Insight.Intake.ActivityPointer activity_pointer_fax
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.ActivityPointer>("activity_pointer_fax", null);
			}
			set
			{
				this.OnPropertyChanging("activity_pointer_fax");
				this.SetRelatedEntity<Insight.Intake.ActivityPointer>("activity_pointer_fax", null, value);
		...
		public Insight.Intake.BusinessUnit business_unit_fax_activities
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.BusinessUnit>("business_unit_fax_activities", null);
			}
		}
		...
		public Insight.Intake.Contact Contact_Faxes
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.Contact>("Contact_Faxes", null);
			}
			set
			{
				this.OnPropertyChanging("Contact_Faxes");
				this.SetRelatedEntity<Insight.Intake.Contact>("Contact_Faxes", null, value);
		...
		public Insight.Intake.Entitlement entitlement_Faxes
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.Entitlement>("entitlement_Faxes", null);
			}
			set
			{
				this.OnPropertyChanging("entitlement_Faxes");
				this.SetRelatedEntity<Insight.Intake.Entitlement>("entitlement_Faxes", null, value);
		...
		public Insight.Intake.EntitlementTemplate entitlementtemplate_Faxes
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.EntitlementTemplate>("entitlementtemplate_Faxes", null);
			}
			set
			{
				this.OnPropertyChanging("entitlementtemplate_Faxes");
				this.SetRelatedEntity<Insight.Intake.EntitlementTemplate>("entitlementtemplate_Faxes", null, value);
		...
		public Insight.Intake.Incident Incident_Faxes
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.Incident>("Incident_Faxes", null);
			}
			set
			{
				this.OnPropertyChanging("Incident_Faxes");
				this.SetRelatedEntity<Insight.Intake.Incident>("Incident_Faxes", null, value);
		...
		public Insight.Intake.Invoice Invoice_Faxes
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.Invoice>("Invoice_Faxes", null);
			}
			set
			{
				this.OnPropertyChanging("Invoice_Faxes");
				this.SetRelatedEntity<Insight.Intake.Invoice>("Invoice_Faxes", null, value);
				this.OnPropertyChanged("Invoice_Faxes");
			}
		}
		
		/// <summary>
		/// N:1 ipg_claimresponseheader_Faxes
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ipg_claimresponseheader_Faxes")]
		public Insight.Intake.ipg_claimresponseheader ipg_claimresponseheader_Faxes
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.ipg_claimresponseheader>("ipg_claimresponseheader_Faxes", null);
			}
			set
			{
				this.OnPropertyChanging("ipg_claimresponseheader_Faxes");
				this.SetRelatedEntity<Insight.Intake.ipg_claimresponseheader>("ipg_claimresponseheader_Faxes", null, value);
				this.OnPropertyChanged("ipg_claimresponseheader_Faxes");
			}
		}
		
		/// <summary>
		/// N:1 ipg_cptcode_Faxes
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ipg_cptcode_Faxes")]
		public Insight.Intake.ipg_cptcode ipg_cptcode_Faxes
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.ipg_cptcode>("ipg_cptcode_Faxes", null);
			}
			set
			{
				this.OnPropertyChanging("ipg_cptcode_Faxes");
				this.SetRelatedEntity<Insight.Intake.ipg_cptcode>("ipg_cptcode_Faxes", null, value);
				this.OnPropertyChanged("ipg_cptcode_Faxes");
			}
		}
		
		/// <summary>
		/// N:1 ipg_document_Faxes
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ipg_document_Faxes")]
		public Insight.Intake.ipg_document ipg_document_Faxes
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.ipg_document>("ipg_document_Faxes", null);
			}
			set
			{
				this.OnPropertyChanging("ipg_document_Faxes");
				this.SetRelatedEntity<Insight.Intake.ipg_document>("ipg_document_Faxes", null, value);
				this.OnPropertyChanged("ipg_document_Faxes");
			}
		}
		
		/// <summary>
		/// N:1 ipg_ehrstaging_Faxes
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ipg_ehrstaging_Faxes")]
		public Insight.Intake.ipg_EHRstaging ipg_ehrstaging_Faxes
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.ipg_EHRstaging>("ipg_ehrstaging_Faxes", null);
			}
			set
			{
				this.OnPropertyChanging("ipg_ehrstaging_Faxes");
				this.SetRelatedEntity<Insight.Intake.ipg_EHRstaging>("ipg_ehrstaging_Faxes", null, value);
				this.OnPropertyChanged("ipg_ehrstaging_Faxes");
			}
		}
		
		/// <summary>
		/// N:1 ipg_patientpaymentnotification_Faxes
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ipg_patientpaymentnotification_Faxes")]
		public Insight.Intake.ipg_patientpaymentnotification ipg_patientpaymentnotification_Faxes
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.ipg_patientpaymentnotification>("ipg_patientpaymentnotification_Faxes", null);
			}
			set
			{
				this.OnPropertyChanging("ipg_patientpaymentnotification_Faxes");
				this.SetRelatedEntity<Insight.Intake.ipg_patientpaymentnotification>("ipg_patientpaymentnotification_Faxes", null, value);
				this.OnPropertyChanged("ipg_patientpaymentnotification_Faxes");
			}
		}
		
		/// <summary>
		/// N:1 ipg_procedurename_Faxes
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ipg_procedurename_Faxes")]
		public Insight.Intake.ipg_procedurename ipg_procedurename_Faxes
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.ipg_procedurename>("ipg_procedurename_Faxes", null);
			}
			set
			{
				this.OnPropertyChanging("ipg_procedurename_Faxes");
				this.SetRelatedEntity<Insight.Intake.ipg_procedurename>("ipg_procedurename_Faxes", null, value);
				this.OnPropertyChanged("ipg_procedurename_Faxes");
			}
		}
		
		/// <summary>
		/// N:1 ipg_referral_Faxes
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ipg_referral_Faxes")]
		public Insight.Intake.ipg_referral ipg_referral_Faxes
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.ipg_referral>("ipg_referral_Faxes", null);
			}
			set
			{
				this.OnPropertyChanging("ipg_referral_Faxes");
				this.SetRelatedEntity<Insight.Intake.ipg_referral>("ipg_referral_Faxes", null, value);
		...
		public Insight.Intake.KnowledgeArticle KnowledgeArticle_Faxes
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.KnowledgeArticle>("KnowledgeArticle_Faxes", null);
			}
			set
			{
				this.OnPropertyChanging("KnowledgeArticle_Faxes");
				this.SetRelatedEntity<Insight.Intake.KnowledgeArticle>("KnowledgeArticle_Faxes", null, value);
		...
		public Insight.Intake.KnowledgeBaseRecord KnowledgeBaseRecord_Faxes
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.KnowledgeBaseRecord>("KnowledgeBaseRecord_Faxes", null);
			}
			set
			{
				this.OnPropertyChanging("KnowledgeBaseRecord_Faxes");
				this.SetRelatedEntity<Insight.Intake.KnowledgeBaseRecord>("KnowledgeBaseRecord_Faxes", null, value);
		...
		public Insight.Intake.Lead Lead_Faxes
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.Lead>("Lead_Faxes", null);
			}
			set
			{
				this.OnPropertyChanging("Lead_Faxes");
				this.SetRelatedEntity<Insight.Intake.Lead>("Lead_Faxes", null, value);
		...
		public Insight.Intake.SystemUser lk_fax_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_fax_createdby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_fax_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_fax_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_fax_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_fax_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_fax_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_fax_modifiedby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_fax_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_fax_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_fax_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_fax_modifiedonbehalfby", null, value);
		...
		public Insight.Intake.SLA manualsla_fax
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SLA>("manualsla_fax", null);
			}
			set
			{
				this.OnPropertyChanging("manualsla_fax");
				this.SetRelatedEntity<Insight.Intake.SLA>("manualsla_fax", null, value);
		...
		public Insight.Intake.Quote Quote_Faxes
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.Quote>("Quote_Faxes", null);
			}
			set
			{
				this.OnPropertyChanging("Quote_Faxes");
				this.SetRelatedEntity<Insight.Intake.Quote>("Quote_Faxes", null, value);
		...
		public Insight.Intake.SalesOrder SalesOrder_Faxes
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SalesOrder>("SalesOrder_Faxes", null);
			}
			set
			{
				this.OnPropertyChanging("SalesOrder_Faxes");
				this.SetRelatedEntity<Insight.Intake.SalesOrder>("SalesOrder_Faxes", null, value);
		...
		public Insight.Intake.Service service_faxes
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.Service>("service_faxes", null);
			}
			set
			{
				this.OnPropertyChanging("service_faxes");
				this.SetRelatedEntity<Insight.Intake.Service>("service_faxes", null, value);
		...
		public Insight.Intake.SLA sla_fax
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SLA>("sla_fax", null);
			}
		}
		...
		public Insight.Intake.Team team_fax
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.Team>("team_fax", null);
			}
		}
		...
		public Insight.Intake.TransactionCurrency TransactionCurrency_Fax
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.TransactionCurrency>("TransactionCurrency_Fax", null);
			}
			set
			{
				this.OnPropertyChanging("TransactionCurrency_Fax");
				this.SetRelatedEntity<Insight.Intake.TransactionCurrency>("TransactionCurrency_Fax", null, value);
		...
		public Insight.Intake.SystemUser user_fax
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("user_fax", null);
			}
		}
