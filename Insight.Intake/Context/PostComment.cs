...
namespace Insight.Intake
{
	...
	public partial class PostComment : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Insight.Intake.SystemUser lk_postcomment_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_postcomment_createdby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_postcomment_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_postcomment_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_postcomment_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_postcomment_createdonbehalfby", null, value);
		...
		public Insight.Intake.Post Post_Comments
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.Post>("Post_Comments", null);
			}
			set
			{
				this.OnPropertyChanging("Post_Comments");
				this.SetRelatedEntity<Insight.Intake.Post>("Post_Comments", null, value);
