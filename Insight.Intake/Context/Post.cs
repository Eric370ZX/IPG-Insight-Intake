...
namespace Insight.Intake
{
	...
	public partial class Post : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.AsyncOperation> post_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.AsyncOperation>("post_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("post_AsyncOperations");
				this.SetRelatedEntities<Insight.Intake.AsyncOperation>("post_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.PostComment> Post_Comments
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.PostComment>("Post_Comments", null);
			}
			set
			{
				this.OnPropertyChanging("Post_Comments");
				this.SetRelatedEntities<Insight.Intake.PostComment>("Post_Comments", null, value);
		...
		public Insight.Intake.SystemUser lk_post_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_post_createdby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_post_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_post_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_post_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_post_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_post_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_post_modifiedby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_post_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_post_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_post_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_post_modifiedonbehalfby", null, value);
