...
namespace Insight.Intake
{
	...
	public partial class KnowledgeSearchModel : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Insight.Intake.KnowledgeSearchModelState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Insight.Intake.KnowledgeSearchModelState)(System.Enum.ToObject(typeof(Insight.Intake.KnowledgeSearchModelState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public Insight.Intake.SystemUser lk_knowledgesearchmodel_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_knowledgesearchmodel_createdby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_knowledgesearchmodel_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_knowledgesearchmodel_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_knowledgesearchmodel_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_knowledgesearchmodel_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_knowledgesearchmodel_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_knowledgesearchmodel_modifiedby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_knowledgesearchmodel_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_knowledgesearchmodel_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_knowledgesearchmodel_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_knowledgesearchmodel_modifiedonbehalfby", null, value);
