...
namespace Insight.Intake
{
	...
	public partial class QueueMembership : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.Queue> queuemembership_association
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.Queue>("queuemembership_association", null);
			}
			set
			{
				this.OnPropertyChanging("queuemembership_association");
				this.SetRelatedEntities<Insight.Intake.Queue>("queuemembership_association", null, value);
