...
namespace Insight.Intake
{
	...
	public partial class EntitlementTemplateProducts : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.AsyncOperation> entitlementtemplateproducts_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.AsyncOperation>("entitlementtemplateproducts_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("entitlementtemplateproducts_AsyncOperations");
				this.SetRelatedEntities<Insight.Intake.AsyncOperation>("entitlementtemplateproducts_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.PrincipalObjectAttributeAccess> entitlementtemplateproducts_PrincipalObjectAttributeAccesses
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.PrincipalObjectAttributeAccess>("entitlementtemplateproducts_PrincipalObjectAttributeAccesses", null);
			}
			set
			{
				this.OnPropertyChanging("entitlementtemplateproducts_PrincipalObjectAttributeAccesses");
				this.SetRelatedEntities<Insight.Intake.PrincipalObjectAttributeAccess>("entitlementtemplateproducts_PrincipalObjectAttributeAccesses", null, value);
