...
namespace Insight.Intake
{
	...
	public partial class ContactInvoices : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.AsyncOperation> contactinvoices_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.AsyncOperation>("contactinvoices_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("contactinvoices_AsyncOperations");
				this.SetRelatedEntities<Insight.Intake.AsyncOperation>("contactinvoices_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.PrincipalObjectAttributeAccess> contactinvoices_PrincipalObjectAttributeAccesses
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.PrincipalObjectAttributeAccess>("contactinvoices_PrincipalObjectAttributeAccesses", null);
			}
			set
			{
				this.OnPropertyChanging("contactinvoices_PrincipalObjectAttributeAccesses");
				this.SetRelatedEntities<Insight.Intake.PrincipalObjectAttributeAccess>("contactinvoices_PrincipalObjectAttributeAccesses", null, value);
