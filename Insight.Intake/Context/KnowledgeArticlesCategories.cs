...
namespace Insight.Intake
{
	...
	public partial class KnowledgeArticlesCategories : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.KnowledgeArticle> knowledgearticle_category
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.KnowledgeArticle>("knowledgearticle_category", null);
			}
			set
			{
				this.OnPropertyChanging("knowledgearticle_category");
				this.SetRelatedEntities<Insight.Intake.KnowledgeArticle>("knowledgearticle_category", null, value);
