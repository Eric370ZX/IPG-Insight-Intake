...
namespace Insight.Intake
{
	...
	public partial class RelationshipRole : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Insight.Intake.RelationshipRoleState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Insight.Intake.RelationshipRoleState)(System.Enum.ToObject(typeof(Insight.Intake.RelationshipRoleState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.RelationshipRoleMap> relationship_role_relationship_role_map
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.RelationshipRoleMap>("relationship_role_relationship_role_map", null);
			}
			set
			{
				this.OnPropertyChanging("relationship_role_relationship_role_map");
				this.SetRelatedEntities<Insight.Intake.RelationshipRoleMap>("relationship_role_relationship_role_map", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.AsyncOperation> RelationshipRole_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.AsyncOperation>("RelationshipRole_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("RelationshipRole_AsyncOperations");
				this.SetRelatedEntities<Insight.Intake.AsyncOperation>("RelationshipRole_AsyncOperations", null, value);
		...
		public Insight.Intake.SystemUser createdby_relationship_role
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("createdby_relationship_role", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_relationshiprole_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_relationshiprole_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_relationshiprole_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_relationshiprole_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_relationshiprole_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_relationshiprole_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_relationshiprole_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_relationshiprole_modifiedonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser modifiedby_relationship_role
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("modifiedby_relationship_role", null);
			}
		}
