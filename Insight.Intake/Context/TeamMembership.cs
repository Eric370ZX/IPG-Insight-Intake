...
namespace Insight.Intake
{
	...
	public partial class TeamMembership : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.Team> teammembership_association
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.Team>("teammembership_association", null);
			}
			set
			{
				this.OnPropertyChanging("teammembership_association");
				this.SetRelatedEntities<Insight.Intake.Team>("teammembership_association", null, value);
