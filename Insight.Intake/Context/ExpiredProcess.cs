...
namespace Insight.Intake
{
	...
	public partial class ExpiredProcess : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Insight.Intake.ExpiredProcessState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Insight.Intake.ExpiredProcessState)(System.Enum.ToObject(typeof(Insight.Intake.ExpiredProcessState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public Insight.Intake.SystemUser lk_expiredprocess_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_expiredprocess_createdby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_expiredprocess_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_expiredprocess_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_expiredprocess_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_expiredprocess_createdonbehalfby", null, value);
		...
		public Insight.Intake.KnowledgeArticle lk_expiredprocess_knowledgearticleid
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.KnowledgeArticle>("lk_expiredprocess_knowledgearticleid", null);
			}
			set
			{
				this.OnPropertyChanging("lk_expiredprocess_knowledgearticleid");
				this.SetRelatedEntity<Insight.Intake.KnowledgeArticle>("lk_expiredprocess_knowledgearticleid", null, value);
		...
		public Insight.Intake.SystemUser lk_expiredprocess_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_expiredprocess_modifiedby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_expiredprocess_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_expiredprocess_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_expiredprocess_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_expiredprocess_modifiedonbehalfby", null, value);
		...
		public Insight.Intake.TransactionCurrency transactioncurrency_expiredprocess
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.TransactionCurrency>("transactioncurrency_expiredprocess", null);
			}
			set
			{
				this.OnPropertyChanging("transactioncurrency_expiredprocess");
				this.SetRelatedEntity<Insight.Intake.TransactionCurrency>("transactioncurrency_expiredprocess", null, value);
