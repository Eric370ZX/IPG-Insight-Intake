...
namespace Insight.Intake
{
	...
	public partial class EntityMap : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.AttributeMap> entity_map_attribute_maps
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.AttributeMap>("entity_map_attribute_maps", null);
			}
			set
			{
				this.OnPropertyChanging("entity_map_attribute_maps");
				this.SetRelatedEntities<Insight.Intake.AttributeMap>("entity_map_attribute_maps", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.AsyncOperation> EntityMap_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.AsyncOperation>("EntityMap_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("EntityMap_AsyncOperations");
				this.SetRelatedEntities<Insight.Intake.AsyncOperation>("EntityMap_AsyncOperations", null, value);
		...
		public Insight.Intake.SystemUser createdby_entitymap
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("createdby_entitymap", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_entitymap_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_entitymap_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_entitymap_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_entitymap_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_entitymap_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_entitymap_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_entitymap_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_entitymap_modifiedonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser modifiedby_entitymap
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("modifiedby_entitymap", null);
			}
		}
