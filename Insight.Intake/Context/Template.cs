...
namespace Insight.Intake
{
	...
	public partial class Template : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.Email> Email_EmailTemplate
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.Email>("Email_EmailTemplate", null);
			}
			set
			{
				this.OnPropertyChanging("Email_EmailTemplate");
				this.SetRelatedEntities<Insight.Intake.Email>("Email_EmailTemplate", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.ConvertRule> emailtemplate_convertrule
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.ConvertRule>("emailtemplate_convertrule", null);
			}
			set
			{
				this.OnPropertyChanging("emailtemplate_convertrule");
				this.SetRelatedEntities<Insight.Intake.ConvertRule>("emailtemplate_convertrule", null, value);
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.AsyncOperation> Template_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.AsyncOperation>("Template_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("Template_AsyncOperations");
				this.SetRelatedEntities<Insight.Intake.AsyncOperation>("Template_AsyncOperations", null, value);
		...
		public Insight.Intake.BusinessUnit business_unit_templates
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.BusinessUnit>("business_unit_templates", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_templatebase_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_templatebase_createdby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_templatebase_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_templatebase_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_templatebase_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_templatebase_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_templatebase_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_templatebase_modifiedby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_templatebase_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_templatebase_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_templatebase_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_templatebase_modifiedonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser system_user_email_templates
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("system_user_email_templates", null);
			}
		}
		...
		public Insight.Intake.Team team_email_templates
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.Team>("team_email_templates", null);
			}
		}
