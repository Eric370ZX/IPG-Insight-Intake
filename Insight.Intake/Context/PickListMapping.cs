...
namespace Insight.Intake
{
	...
	public partial class PickListMapping : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Insight.Intake.PickListMappingState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Insight.Intake.PickListMappingState)(System.Enum.ToObject(typeof(Insight.Intake.PickListMappingState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public Insight.Intake.SystemUser lk_picklistmapping_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_picklistmapping_createdby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_picklistmapping_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_picklistmapping_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_picklistmapping_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_picklistmapping_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_picklistmapping_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_picklistmapping_modifiedby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_picklistmapping_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_picklistmapping_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_picklistmapping_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_picklistmapping_modifiedonbehalfby", null, value);
