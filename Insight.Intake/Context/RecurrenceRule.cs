...
namespace Insight.Intake
{
	...
	public partial class RecurrenceRule : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Insight.Intake.RecurringAppointmentMaster> recurrencerule_recurringappointmentmaster
		{
			get
			{
				return this.GetRelatedEntities<Insight.Intake.RecurringAppointmentMaster>("recurrencerule_recurringappointmentmaster", null);
			}
			set
			{
				this.OnPropertyChanging("recurrencerule_recurringappointmentmaster");
				this.SetRelatedEntities<Insight.Intake.RecurringAppointmentMaster>("recurrencerule_recurringappointmentmaster", null, value);
		...
		public Insight.Intake.ActivityPointer activity_pointer_recurrencerule
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.ActivityPointer>("activity_pointer_recurrencerule", null);
			}
			set
			{
				this.OnPropertyChanging("activity_pointer_recurrencerule");
				this.SetRelatedEntity<Insight.Intake.ActivityPointer>("activity_pointer_recurrencerule", null, value);
		...
		public Insight.Intake.BusinessUnit business_unit_recurrencerule
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.BusinessUnit>("business_unit_recurrencerule", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_recurrencerule_createdby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_recurrencerule_createdby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_recurrencerule_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_recurrencerule_modifiedby", null);
			}
		}
		...
		public Insight.Intake.SystemUser lk_recurrencerulebase_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_recurrencerulebase_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_recurrencerulebase_createdonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_recurrencerulebase_createdonbehalfby", null, value);
		...
		public Insight.Intake.SystemUser lk_recurrencerulebase_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Insight.Intake.SystemUser>("lk_recurrencerulebase_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_recurrencerulebase_modifiedonbehalfby");
				this.SetRelatedEntity<Insight.Intake.SystemUser>("lk_recurrencerulebase_modifiedonbehalfby", null, value);
