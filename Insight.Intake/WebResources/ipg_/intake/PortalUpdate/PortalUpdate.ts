namespace Intake.PortalUpdate {
  ...
  export function validateDisplayStartDateOnChange(executionContext) {
  ...
  export function validateDisplayEndDateOnChange(executionContext) {
    var formContext = executionContext.getFormContext();
  ...
  export function isAllFacilitiesOnChange(executionContext) {
    var formContext = executionContext.getFormContext();
