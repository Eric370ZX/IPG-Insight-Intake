function StatesExempt(formContext) {
    ...
    var stateFieldNames = new Array(
        "ipg_permimplanttaxtype",
        "ipg_extcomponenttaxtype",
        "ipg_surgicaltooltaxtype",
        "ipg_tempimplanttaxtype",
        "ipg_medicalsupplytaxtype",
        "ipg_extaccessorytaxtype",
        "ipg_kittaxtype"
