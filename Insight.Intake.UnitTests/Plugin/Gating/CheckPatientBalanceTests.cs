...
{
    public class CheckPatientBalanceTests : PluginTestsBase
    {
        [Fact]
        public void CheckPatientBalanceTests_ZeroBalance_returnSuccess()
        {
            //arrange
            var fakedContext = new XrmFakedContext();

            Incident caseEntity = new Incident().Fake();
            caseEntity.ipg_ActualMemberResponsibility = null;  
            ...
            {
                MessageName = "ipg_IPGGatingCheckPatientBalance",
                Stage = 40,
            ...
            //ACT
            fakedContext.ExecutePluginWith<CheckPatientBalance>(pluginContext);
        ...
        [Fact]
        public void CheckPatientBalanceTests_CreditBalance_returnError()
        {
            //arrange
            var fakedContext = new XrmFakedContext();

            Incident caseEntity = new Incident().Fake();
            caseEntity.ipg_RemainingPatientBalance = new Money(-10);
